pipeline {
    ...
    stages {
      stage('CI Build and push snapshot') {
        ...
        steps {
          dir ('/home/jenkins/go/src/github.com/rawlingsj/golang-http-example1') {
            checkout scm
            container('go') {
              sh "make linux"
          ...
          dir ('/home/jenkins/go/src/github.com/rawlingsj/golang-http-example1/charts/preview') {
            container('go') {
              sh "make preview"
      ...
      stage('Build Release') {
        ...
        steps {
          container('go') {
            ...
            dir ('/home/jenkins/go/src/github.com/rawlingsj/golang-http-example1/charts/golang-http-example1') {
